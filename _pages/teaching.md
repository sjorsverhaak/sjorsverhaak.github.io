...
<style>
  ...
  .teaching-details { margin-top: 0.5rem; }
  .teaching-details > summary { list-style: none; cursor: pointer; position: relative; padding-right: 1.5rem; }
  ...
  .teaching-details > summary .course-title { font-size: 2rem; font-weight: 400; line-height: 1.25; }
  .teaching-details[open] > summary .course-title { border-bottom: 1px solid var(--global-divider-color, #eaecef); padding-bottom: 0.25rem; }
  .teaching-details .syllabus { margin-top: 1rem; }
  .teaching-details .syllabus h2 { margin-top: 1.25rem; }
  .teaching-details .syllabus hr { margin: 1rem 0; }
</style>


<h1 style="font-size: 2.5rem; font-weight: bold;">My Courses</h1>
